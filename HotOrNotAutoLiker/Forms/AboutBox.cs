...
namespace HotOrNotAutoLiker
{
    ...
    public partial class AboutBox : Form
    {
        ...
        public AboutBox()
        {
            ...
            this.labelVersion.Text = string.Format(CultureInfo.InvariantCulture, "Version: {0}", Settings.Instance.AssemblyVersion);

            this.labelCopyright.Text = AssemblyCopyright;
            this.lblEmail.Text = "jivko89@yahoo.com";
            this.textBoxDescription.Text = AssemblyDescription + "For any bugs or fixes write me down to the email. Also if you liked my work, I will be happy if you donate.";
        }
        ...
        {
            this.ttHover.SetToolTip(this.btnDonate, "Donate for Hot Or Not Auto Liker");
            this.ttHover.SetToolTip(this.lblEmail, "mailto:jivko89@yahoo.com");
            this.ttHover.SetToolTip(this.logoPictureBox, "Open my blog");
            this.copyEmailToolStripMenuItem.ToolTipText = "Copy email to clipboard";
        }
