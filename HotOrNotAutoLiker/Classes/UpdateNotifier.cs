...
namespace HotOrNotAutoLiker.Classes
{
    /// <summary>
    ...
    public class UpdateNotifier : IDisposable
    {
        ...
        /// </summary>
        private readonly Uri githubReleasesUri = new Uri(@"https://github.com/unholyHub/HotOrNotAutoLiker/releases");
        ...
        {
            MessageBox.Show(string.Format(@"Your version ({0}) is outdated. 
Do you like to download latest version ({1})?", Settings.Instance.AssemblyVersion, DownloadedVersionNumber));
        }
